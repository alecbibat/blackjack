...
def deal(deck, card_values)
	...
	puts "******************"
	puts "DEALER'S SECOND CARD : #{deck[rand_4]}" #deck[rand]
	puts "******************"
...
def evaluate_hand(deck, card_1, card_2, card_values, d_card_1, d_card_2)
	...
	puts "The dealer's hand value is #{d_hand_value}"
...
def game_over(hand_value, d_hand_value)
	...
	puts "Your hand value was #{d_hand_value}"
	puts "The dealer's hand value was #{hand_value}"
